...
extends EntityFilterList {
    ...
    public static CrystalAuraFilterList create() {
        ...
        builder.add(new FilterHostileSetting("Won't target hostile mobs like zombies and creepers when auto-placing crystals." + damageWarning, true));
        builder.add(new FilterNeutralSetting("Won't target neutral mobs like endermen and wolves when auto-placing crystals." + damageWarning, AttackDetectingEntityFilter.Mode.ON));
        builder.add(new FilterPassiveSetting("Won't target animals like pigs and cows, ambient mobs like bats, and water mobs like fish, squid and dolphins when auto-placing crystals." + damageWarning, true));
        builder.add(new FilterPassiveWaterSetting("Won't target passive water mobs like fish, squid, dolphins and axolotls when auto-placing crystals." + damageWarning, true));
        builder.add(new FilterBatsSetting("Won't target bats and any other \"ambient\" mobs when auto-placing crystals." + damageWarning, true));
        builder.add(new FilterSlimesSetting("Won't target slimes when auto-placing crystals." + damageWarning, true));
        builder.add(new FilterVillagersSetting("Won't target villagers and wandering traders when auto-placing crystals." + damageWarning, true));
        builder.add(new FilterZombieVillagersSetting("Won't target zombified villagers when auto-placing crystals." + damageWarning, true));
        builder.add(new FilterGolemsSetting("Won't target iron golems and snow golems when auto-placing crystals." + damageWarning, true));
        builder.add(new FilterPiglinsSetting("Won't target piglins when auto-placing crystals." + damageWarning, AttackDetectingEntityFilter.Mode.ON));
        builder.add(new FilterZombiePiglinsSetting("Won't target zombified piglins when auto-placing crystals." + damageWarning, AttackDetectingEntityFilter.Mode.ON));
        builder.add(new FilterShulkersSetting("Won't target shulkers when auto-placing crystals." + damageWarning, true));
