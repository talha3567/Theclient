...
extends class_437 {
    ...
    public void method_25426() {
        this.listGui = new ListGui(this.field_22787, this, this.blockList.getBlockNames());
        this.method_25429((class_364)this.listGui);
        this.blockNameField = new class_342(this.field_22787.field_1772, this.field_22789 / 2 - 152, this.field_22790 - 56, 150, 20, (class_2561)class_2561.method_43470((String)""));
        this.method_25429((class_364)this.blockNameField);
        this.blockNameField.method_1880(256);
        ...
        this.removeButton = class_4185.method_46430((class_2561)class_2561.method_43470((String)"Remove Selected"), b -> {
            this.blockList.remove(this.blockList.indexOf(this.listGui.getSelectedBlockName()));
            this.field_22787.method_1507((class_437)this);
    ...
    public boolean method_25402(class_11909 context, boolean doubleClick) {
        this.blockNameField.method_25402(context, doubleClick);
    ...
    public boolean method_25404(class_11908 context) {
        switch (context.comp_4795()) {
            ...
            case 261: {
                if (this.blockNameField.method_25370()) break;
    ...
    public void method_25393() {
        String nameOrId = this.blockNameField.method_1882();
        this.blockToAdd = BlockUtils.getBlockFromNameOrID(nameOrId);
        this.addButton.field_22763 = this.blockToAdd != null;
    ...
    public void method_25394(class_332 context, int mouseX, int mouseY, float partialTicks) {
        ...
        context.method_25300(this.field_22787.field_1772, this.blockList.getName() + " (" + this.blockList.size() + ")", this.field_22789 / 2, 12, -1);
        matrixStack.pushMatrix();
        this.blockNameField.method_25394(context, mouseX, mouseY, partialTicks);
        ...
        if (this.blockNameField.method_1882().isEmpty() && !this.blockNameField.method_25370()) {
            context.method_25303(this.field_22787.field_1772, "block name or ID", 68, this.field_22790 - 50, -8355712);
        }
        int border = this.blockNameField.method_25370() ? -1 : -6250336;
        int black = -16777216;
        ...
        RenderUtils.drawItem(context, this.blockToAdd == null ? class_1799.field_8037 : new class_1799((class_1935)this.blockToAdd), this.field_22789 / 2 - 164, this.field_22790 - 52, false);
        matrixStack.popMatrix();
    }
    ...
    extends class_4280<Entry> {
        public ListGui(class_310 minecraft, EditBlockListScreen screen, List<String> list) {
    ...
    extends class_4280.class_4281<Entry> {
        ...
        public class_2561 method_37006() {
            class_2248 block = BlockUtils.getBlockFromName(this.blockName);
            class_1799 stack = new class_1799((class_1935)block);
            return class_2561.method_43469((String)"narrator.select", (Object[])new Object[]{"Block " + this.getDisplayName(stack) + ", " + this.blockName + ", " + this.getIdText(block)});
        }
        ...
        public void method_25343(class_332 context, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            class_2248 block = BlockUtils.getBlockFromName(this.blockName);
            class_1799 stack = new class_1799((class_1935)block);
            class_327 tr = ((EditBlockListScreen)EditBlockListScreen.this).field_22787.field_1772;
            RenderUtils.drawItem(context, stack, x + 1, y + 1, true);
            context.method_51433(tr, this.getDisplayName(stack), x + 28, y, -986896, false);
            context.method_51433(tr, this.blockName, x + 28, y + 9, -6250336, false);
            context.method_51433(tr, this.getIdText(block), x + 28, y + 18, -6250336, false);
        }

        private String getDisplayName(class_1799 stack) {
            return stack.method_7960() ? "\u00a7ounknown block\u00a7r" : stack.method_7964().getString();
        }

        private String getIdText(class_2248 block) {
            return "ID: " + class_2248.method_9507((class_2680)block.method_9564());
        }
    }
}
