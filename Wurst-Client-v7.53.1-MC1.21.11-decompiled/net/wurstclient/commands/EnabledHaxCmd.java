...
@DontBlock
public final class EnabledHaxCmd
extends Command {
    public EnabledHaxCmd() {
        super("enabledhax", "Allows you to make profiles of enabled hacks.", ".enabledhax load-profile <file>", ".enabledhax save-profile <file>", ".enabledhax list-profiles [<page>]", "Profiles are saved in '.minecraft/wurst/enabled hacks'.");
    }
    ...
    private void listProfiles(String[] args) throws CmdException {
        ...
        ChatUtils.message("Enabled hacks profile list (page " + page + "/" + pages + ")");
