...
public final class NewChunksOutlineRenderer
implements NewChunksChunkRenderer {
    ...
    public void buildBuffer(class_4588 buffer, Set<class_1923> chunks, int drawDistance) {
        ...
        for (class_1923 chunkPos : chunks) {
            ...
            float z2 = z1 + 15.0f;
            int color = -1;
            RenderUtils.drawLine(buffer, x1, 0.0f, z1, x2, 0.0f, z1, color);
            RenderUtils.drawLine(buffer, x2, 0.0f, z1, x2, 0.0f, z2, color);
            RenderUtils.drawLine(buffer, x2, 0.0f, z2, x1, 0.0f, z2, color);
            RenderUtils.drawLine(buffer, x1, 0.0f, z2, x1, 0.0f, z1, color);
        }
    }
