...
public final class TorchflowerPlantType
extends AutoFarmPlantType {
    @Override
    public final boolean isReplantingSpot(class_2338 pos, class_2680 state) {
        return (state.method_27852(class_2246.field_42734) || state.method_27852(class_2246.field_42749)) && this.hasPlantingSurface(pos);
    }
    ...
    public boolean shouldHarvestByMining(class_2338 pos, class_2680 state) {
        return state.method_27852(class_2246.field_42734);
    }

    @Override
    protected PlantTypeSetting createSetting() {
        return new PlantTypeSetting("Torchflowers", class_1802.field_42695, true, true);
    }
}
