...
extends AutoFarmPlantType {
    ...
    public boolean shouldHarvestByMining(class_2338 pos, class_2680 state) {
        ...
        if (!(class_22482 instanceof class_2242)) {
            return false;
        }
        class_2242 beetroots = (class_2242)class_22482;
        return beetroots.method_9825(state);
    }

    @Override
    protected PlantTypeSetting createSetting() {
        return new PlantTypeSetting("Beetroots", class_1802.field_8186, true, true);
    }
}
